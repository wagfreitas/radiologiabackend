...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n    \n\n    \n    \n    \n\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbnRlbnQvY2FkYXN0cm9zL2NhZC1lcXVpcGUvY2FkLWVxdWlwZS5jb21wb25lbnQuY3NzIn0= */");
...
/* harmony import */ var src_app_services_cirurgias_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/_services/cirurgias.service */ "./src/app/_services/cirurgias.service.ts");
...
var CadEquipeComponent = /** @class */ (function () {
    function CadEquipeComponent(formBuilder, auth, alertService, datePipe, dadoService, examesService) {
    ...
    CadEquipeComponent.prototype.ngOnInit = function () {
        ...
        this.cadEquipeForm();
        this.examesService.getAll().subscribe(function (mascaras) {
            _this.exames = mascaras;
        });
        this.equipamentos = [
    ...
    CadEquipeComponent.ctorParameters = function () { return [
        ...
        { type: src_app_services_cirurgias_service__WEBPACK_IMPORTED_MODULE_6__["CirurgiasService"] }
    ]; };
    __decorate([
    ...
    CadEquipeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"],
            ...
            src_app_services_cirurgias_service__WEBPACK_IMPORTED_MODULE_6__["CirurgiasService"]])
    ], CadEquipeComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("hr {\n    margin-top: 1.5rem;\n    margin-bottom: 0rem;\n    border: 10;\n    border-top: 3px solid rgba(0, 0, 0, 0);\n  }\n\n  .botao{\n    padding-top: 27px;\n}\n\n\n\n\n\n\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
var MascarasComponent = /** @class */ (function () {
    ...
    MascarasComponent.prototype.pesquisaMascara = function (nomeMascara) {
        var _this = this;
        this.update = true;
        this.exameService.getByName(nomeMascara.mascara).subscribe(function (res) {
            if (res) {
                _this.editExames(res);
                _this.editExamesNormais(res);
                _this.editLaudos(res);
    ...
    MascarasComponent.prototype.editExames = function (res) {
        var _this = this;
        console.log(res);
        this.examesposicao = this.maskForm.get("examesposicao");
        this.examesposicao.clear();
        res.exames.forEach(function (posicao) {
            return _this.examesposicao.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
                exames: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](posicao.exames),
                btncolor: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](posicao.btncolor),
            }));
        });
    };
    ...
    MascarasComponent.prototype.editExamesNormais = function (res) {
        var _this = this;
        this.examesnormais = this.maskForm.get("examesnormais");
        this.examesnormais.clear();
        res.examesnormais.forEach(function (normais) {
            return _this.examesnormais.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
                laudosnormais: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](normais.laudosnormais),
                btncolor: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("primary"),
            }));
        });
    };
    ...
    MascarasComponent.prototype.editLaudos = function (res) {
        var _this = this;
        this.laudossiglas = this.maskForm.get("laudossiglas");
        this.laudossiglas.clear();
        res.laudos.forEach(function (siglas) {
            return _this.laudossiglas.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
                laudos: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](siglas.laudos),
                descricao: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](siglas.descricao),
                btncolor: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](siglas.btncolor),
            }));
        });
    };
    ...
    MascarasComponent.prototype.editLaudosDesc = function (res) {
        var _this = this;
        this.laudosdesc = this.maskForm.get("laudosdesc");
        this.laudosdesc.clear();
        res.laudosmin.forEach(function (descricao) {
            return _this.laudosdesc.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
                laudosmin: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](descricao.laudosmin),
                btncolor: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](descricao.btincolor),
            }));
        });
    };
    ...
    MascarasComponent.prototype.atualizaMascara = function (val) {
        var _this = this;
        var laudosnorm = {
            btncolor: "primary",
            descricao: "NORMAL",
        ...
        this.exameService.editMascara(val.mascara, this.final).then(function (res) {
            console.log("retorno", res);
            _this.clearForm();
        });
        sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
    ...
    MascarasComponent.prototype.deletaMascara = function (val) {
        var _this = this;
        var doc = val.mascara;
        this.exameService.deleteMascara(doc).then(function (res) {
            console.log(res);
            _this.clearForm();
        });
        sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
    ...
    MascarasComponent.prototype.clearForm = function () {
        this.examesposicao.clear();
        this.examesnormais.clear();
        this.laudossiglas.clear();
        this.laudosdesc.clear();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("mat-form-field {\n    width: 100%;\n    margin-bottom: 20px;\n}\n\n@media (min-width: 768px) {\n    .mat-card-content {\n        display: flex;\n        flex-wrap: wrap;\n    }\n\n    .mat-form-field {\n        flex-basis: calc(50% - 20px);\n        margin-right: 20px;\n    }\n\n    .mat-form-field:nth-child(2n) {\n        margin-right: 0;\n    }\n\n    @media (min-width: 992px) {\n        .mat-form-field {\n            flex-basis: calc(33.33% - 20px);\n        }\n\n        .mat-form-field:nth-child(2n) {\n            margin-right: 20px;\n        }\n\n        .mat-form-field:nth-child(3n) {\n            margin-right: 0;\n        }\n    }\n}\n/*# sourceMappingURL=data:application/json;base64, */");
